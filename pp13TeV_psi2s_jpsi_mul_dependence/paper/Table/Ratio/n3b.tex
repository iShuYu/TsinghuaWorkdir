\begin{table}[H]
\caption{Ratios (\%) of double differential production cross-section for \psitwos to \jpsi in bins of (\pt,$y$) for 15 $\leq$ $N_{\rm bwd}^{\rm PV}$ $<$ 22. The first uncertainties are statistical, the second are systematic. }
\centering
