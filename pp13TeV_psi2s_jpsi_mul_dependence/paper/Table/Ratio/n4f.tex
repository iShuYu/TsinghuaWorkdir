\begin{table}[H]
\caption{Ratios (\%) of double differential production cross-section for \psitwos to \jpsi in bins of (\pt,$y$) for 36 $\leq$ $N_{\rm fwd}^{\rm PV}$ $<$ 48. The first uncertainties are statistical, the second are systematic. }
\centering
