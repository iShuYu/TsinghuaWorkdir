...
int main(int argc, char *argv[])
{
	...
	for(Long64_t jentry = 0; jentry <= Num_Entries; jentry++)
	{
		...
		tz = (t.psi_ENDVERTEX_Z-t.psi_OWNPV_Z)/t.psi_PZ * 10.0 * 3686. / 2.9979;
		tzError = sqrt(t.psi_ENDVERTEX_ZERR * t.psi_ENDVERTEX_ZERR + t.psi_OWNPV_ZERR * t.psi_OWNPV_ZERR) / t.psi_PZ * 10.0 * 3686. / 2.9979;
		...
		if(!(
			...
			t.psi_Hlt1Global_TIS == 1 &&
			//t.psi_Hlt2DiMuonPsi2STurboDecision_TIS == 1&&
