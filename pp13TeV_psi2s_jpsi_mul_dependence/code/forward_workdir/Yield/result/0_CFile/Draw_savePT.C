...
int main(int argc, char* argv[])
{
	...
	for(int th=0;th<5;th++)
	{
		...
		//gmep[th] -> GetXaxis()->SetTitle("#font[12]{N}_{fwd}^{PV}/#LT#font[12]{N}_{fwd}^{PV}#GT_{NB}");
	...
	canb -> cd();
	Titleb -> Draw("same");
	canp -> SaveAs("../4_Plot/promptRatioPTF.pdf");
	canp -> SaveAs("../4_Plot/promptRatioPTF.png");
	canp -> SaveAs("../4_Plot/promptRatioPTF.C");
	canp -> SaveAs("../4_Plot/promptRatioPTF.eps");

	canp -> Close();
	canb -> SaveAs("../4_Plot/frombRatioPTF.pdf");
	canb -> SaveAs("../4_Plot/frombRatioPTF.png");
	canb -> SaveAs("../4_Plot/frombRatioPTF.eps");
	canb -> SaveAs("../4_Plot/frombRatioPTF.C");
