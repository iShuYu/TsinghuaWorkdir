...
///////////////////////////////////////////////////////////////////
  ...
  lhcbStyle->SetLabelSize(0.8*lhcbTSize,"x");
  lhcbStyle->SetLabelSize(0.8*lhcbTSize,"y");
  ...
  // add LHCb label
  //lhcbName = new TPaveText(gStyle->GetPadLeftMargin() + 0.05, 0.3 - gStyle->GetPadTopMargin(), gStyle->GetPadLeftMargin() + 0.20, 0.45 - gStyle->GetPadTopMargin(), 
  lhcbName = new TPaveText(0.5,0.8,0.77,0.9, "BRNDC");
...
//  lhcbName->AddText("LHCb Preliminary");
 // lhcbName->AddText("#sqrt{s} = 5 TeV");
  lhcbName->AddText("LHCb #font[12]{pp} #sqrt{s} = 13 TeV");
