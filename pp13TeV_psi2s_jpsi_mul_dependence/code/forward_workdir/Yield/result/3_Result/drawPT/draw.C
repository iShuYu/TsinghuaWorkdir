...
int main(int argc, char* argv[])
{
	...
	mg -> SetMaximum(10);
	mg -> SetMinimum(0);
        mg -> GetXaxis() -> SetTitle("#font[12]{p}_{T} [GeV/c]");
	...
	leg -> Draw("same");
	rleg -> Draw("same");
	can -> SaveAs("./Comparisons_PT_VariousMeasurements.pdf");
	can -> SaveAs("./Comparisons_PT_VariousMeasurements.png");
	can -> SaveAs("./Comparisons_PT_VariousMeasurements.eps");
	can -> SaveAs("./Comparisons_PT_VariousMeasurements.C");
