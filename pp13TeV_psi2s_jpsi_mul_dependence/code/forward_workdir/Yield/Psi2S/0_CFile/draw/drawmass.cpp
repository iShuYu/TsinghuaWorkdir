...
int main(int argc, char* argv[])
{
	...
	tzPDF->plotOn(plot_frame, Name("fromb"), ProjWData(tzError, *BinData), NumCPU(40, kTRUE), Components("fromb"), FillColor(kCyan), FillStyle(3002), VLines(), DrawOption("F"), LineWidth(0), Normalization(1.0/N));
	...
	plot_frame->Draw();
	TLegend* leg = new TLegend(0.16, 0.77, 0.43, 0.92);
	leg->SetTextFont(132);
	leg->SetBorderSize(0);
