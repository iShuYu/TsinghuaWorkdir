...
// Thu Dec 22 13:54:01 2022 by ROOT version 6.24/06
// from TTree DecayTree/DecayTree
// found on file: 2D.root
//////////////////////////////////////////////////////////

#ifndef CBSplotDecayTree_h
#define CBSplotDecayTree_h
...
class CBSplotDecayTree {
public :
   TTree          *fChain;   //!pointer to the analyzed TTree or TChain
   Int_t           fCurrent; //!current Tree number in a TChain

// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxpsi_ENDVERTEX_COV = 1;
   static constexpr Int_t kMaxpsi_OWNPV_COV = 1;
   ...
   Int_t           psi_nBackTracks;
   Int_t           psi_nForWardTracks;
   ...
   Int_t           mup_nBackTracks;
   Int_t           mup_nForWardTracks;
   ...
   Int_t           mum_nBackTracks;
   Int_t           mum_nForWardTracks;
   ...
   // List of branches
   TBranch        *b_psi_nBackTracks;   //!
   TBranch        *b_psi_nForWardTracks;   //!
   ...
   TBranch        *b_mup_nBackTracks;   //!
   TBranch        *b_mup_nForWardTracks;   //!
   ...
   TBranch        *b_mum_nBackTracks;   //!
   TBranch        *b_mum_nForWardTracks;   //!
   ...
   CBSplotDecayTree(TTree *tree=0);
   virtual ~CBSplotDecayTree();
...
#ifdef CBSplotDecayTree_cxx
CBSplotDecayTree::CBSplotDecayTree(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("2D.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("2D.root");
      }
...
CBSplotDecayTree::~CBSplotDecayTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t CBSplotDecayTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CBSplotDecayTree::LoadTree(Long64_t entry)
{
...
void CBSplotDecayTree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("psi_nBackTracks", &psi_nBackTracks, &b_psi_nBackTracks);
   fChain->SetBranchAddress("psi_nForWardTracks", &psi_nForWardTracks, &b_psi_nForWardTracks);
   ...
   fChain->SetBranchAddress("mup_nBackTracks", &mup_nBackTracks, &b_mup_nBackTracks);
   fChain->SetBranchAddress("mup_nForWardTracks", &mup_nForWardTracks, &b_mup_nForWardTracks);
   ...
   fChain->SetBranchAddress("mum_nBackTracks", &mum_nBackTracks, &b_mum_nBackTracks);
   fChain->SetBranchAddress("mum_nForWardTracks", &mum_nForWardTracks, &b_mum_nForWardTracks);
   ...
   fChain->SetBranchAddress("tzError", &tzError, &b_tzError);
   fChain->SetBranchAddress("psi_Y", &psi_Y, &b_psi_Y);
   fChain->SetBranchAddress("psi_ETA", &psi_ETA, &b_psi_ETA);
   fChain->SetBranchAddress("mup_ETA", &mup_ETA, &b_mup_ETA);
   fChain->SetBranchAddress("mum_ETA", &mum_ETA, &b_mum_ETA);
   fChain->SetBranchAddress("prompt_sw", &prompt_sw, &b_prompt_sw);
   fChain->SetBranchAddress("fromb_sw", &fromb_sw, &b_fromb_sw);
   fChain->SetBranchAddress("bkg_sw", &bkg_sw, &b_bkg_sw);
   Notify();
}

Bool_t CBSplotDecayTree::Notify()
{
...
void CBSplotDecayTree::Show(Long64_t entry)
{
...
Int_t CBSplotDecayTree::Cut(Long64_t entry)
{
...
#endif // #ifdef CBSplotDecayTree_cxx
