...
// Fri Apr 12 08:20:33 2024 by ROOT version 6.30/04
// from TTree mct/mct
// found on file: ../../../../../workdir/Yield/Jpsi/3_Result/RegenVar/newVarMC.root
//////////////////////////////////////////////////////////
...
#ifdef mctNew_cxx
mctNew::mctNew(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../../../../workdir/Yield/Jpsi/3_Result/RegenVar/newVarMC.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../../../../workdir/Yield/Jpsi/3_Result/RegenVar/newVarMC.root");
      }
...
Int_t mctNew::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t mctNew::LoadTree(Long64_t entry)
{
...
void mctNew::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("wn", &wn, &b_wn);
   fChain->SetBranchAddress("PVNrew", &PVNrew, &b_PVNrew);
   Notify();
}

Bool_t mctNew::Notify()
{
...
void mctNew::Show(Long64_t entry)
{
...
Int_t mctNew::Cut(Long64_t entry)
{
