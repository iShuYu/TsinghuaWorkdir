...
int main(int argc, char* argv[])
{
	...
	double PT, Y, N, wp, wb;
	TH1D *Sp_N = new TH1D("Sp_N","Sp_N",50,0,150);
	TH1D *Sb_N = new TH1D("Sb_N","Sb_N",50,0,150);
	TH1D *D_N = new TH1D("D_N","D_N",50,0,150);
	...
	//Save
	TH1D *reweightpN = new TH1D("reweightpN","reweightpN",50,0,150);
	TH2D *reweightpPTY = new TH2D("reweightpPTY","reweightpPTY",20,300,20000,10,2,4.5);
	TH1D *reweightbN = new TH1D("reweightbN","reweightbN",50,0,150);
