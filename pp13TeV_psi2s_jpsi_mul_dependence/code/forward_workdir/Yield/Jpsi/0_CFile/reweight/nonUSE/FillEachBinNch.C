...
int main(int argc, char* argv[])
{
	...
	mb -> Add("../../../../../workdir/Yield/rawdata/1_Rootfile/MCtracks/Jpsi/Tupleb.root");
	mct b(mb);
	...
	TChain *mp = new TChain("mct");
        mp -> Add("../../../../../workdir/Yield/rawdata/1_Rootfile/MCtracks/Jpsi/Tuplep.root");
        mct p(mp);
	...
	TChain *m = new TChain("mct");
        m -> Add("../../../../../workdir/Yield/rawdata/1_Rootfile/MCtracks/Jpsi/Tuple.root");
        mct bp(m);
	int NN = m->GetEntries();
