...
cods = [
        "(INTREE((ID=='mu+')&(TRCHI2DOF<3)&(TRGHOSTPROB<0.3)&(PT>1200*MeV)&(ETA>2.0)&(ETA<4.9)&(PIDmu-PIDpi>2.0)))&(INTREE((ID=='mu-')&(TRCHI2DOF<3)&(TRGHOSTPROB<0.3)&(PT>1200*MeV)&(ETA>2.0)&(ETA<4.9)&(PIDmu-PIDpi>2.0)))&(INTREE((ABSID=='J/psi(1S)')&(PT>2000*MeV)))",
        "(INTREE((ID=='mu+')&(TRCHI2DOF<3)&(TRGHOSTPROB<0.3)&(PT>1200*MeV)&(ETA>2.0)&(ETA<4.9)&(PIDmu-PIDpi>2.0)))&(INTREE((ID=='mu-')&(TRCHI2DOF<3)&(TRGHOSTPROB<0.3)&(PT>1200*MeV)&(ETA>2.0)&(ETA<4.9)&(PIDmu-PIDpi>2.0)))&(INTREE((ABSID=='J/psi(1S)')&(PT>2000*MeV)))",
        ]
...
IOHelper().inputFiles(['/afs/cern.ch/user/x/xianglei/work/pp13psi/00047765_00000011_1.turbo.mdst'])
"""
