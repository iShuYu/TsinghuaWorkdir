...
myApplication.options = [ './DaVinci1SMagUp.py',
                           ]

data = BKQuery(dqflag = "OK" ,path  = "/MC/2015/Beam6500GeV-2015-MagUp-Nu1.6-25ns-Pythia8/Sim09b/Trig0x411400a2/Reco15a/Turbo02/Stripping24NoPrescalingFlagged/24142001/ALLSTREAMS.DST",type = "Path").getDataset()
