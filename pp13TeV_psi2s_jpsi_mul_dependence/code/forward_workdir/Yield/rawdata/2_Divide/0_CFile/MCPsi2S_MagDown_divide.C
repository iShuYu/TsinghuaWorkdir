...
int main(int argc, char *argv[])
{
	...
	F_DecayTree -> Add("~/workdir_local/Yield/rawdata/1_Rootfile/MC/MagDown/Psi2S/MCPsi2S16Down_i.root");
	F_MCDecayTree -> Add("~/workdir_local/Yield/rawdata/1_Rootfile/MC/MagDown/Psi2S/MCPsi2S16Down_i.root");
	F_DecayTree -> Add("~/workdir_local/Yield/rawdata/1_Rootfile/MC/MagDown/Psi2S/MCPsi2S16Down_l.root");
        F_MCDecayTree -> Add("~/workdir_local/Yield/rawdata/1_Rootfile/MC/MagDown/Psi2S/MCPsi2S16Down_l.root");
