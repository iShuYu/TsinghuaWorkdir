...
int main(int argc, char *argv[])
{
	...
	F_DecayTree -> Add("~/workdir_local/Yield/rawdata/1_Rootfile/MC/MagUp/Jpsi/MCJpsi16MagUp_b.root");
	F_MCDecayTree -> Add("~/workdir_local/Yield/rawdata/1_Rootfile/MC/MagUp/Jpsi/MCJpsi16MagUp_b.root");

	MCJpsi tree(F_DecayTree);
	mctJpsi Tree(F_MCDecayTree);

	//output 1
	TFile *F_DecayTree_out = new TFile(Form("../2_AfterDivide/MC/Jpsi/n%d_MagUp.root",num_n),"recreate");
	...
	//output 1 from b
	TFile *F_DecayTree_out_fromb = new TFile(Form("../2_AfterDivide/MC/Jpsi/n%d_MagUp_fromb.root",num_n),"recreate");
	...
	//output 1 prompt
	TFile *F_DecayTree_out_prompt = new TFile(Form("../2_AfterDivide/MC/Jpsi/n%d_MagUp_prompt.root",num_n),"recreate");
	...
	//output 2
        TFile *F_MCDecayTree_out = new TFile(Form("../2_AfterDivide/MC/Jpsi/mctn%d_MagUp.root",num_n),"recreate");
	...
	//output 2 from b
	TFile *F_MCDecayTree_out_fromb = new TFile(Form("../2_AfterDivide/MC/Jpsi/mctn%d_MagUp_fromb.root",num_n),"recreate");
	...
	//output 2 prompt
	TFile *F_MCDecayTree_out_prompt = new TFile(Form("../2_AfterDivide/MC/Jpsi/mctn%d_MagUp_prompt.root",num_n),"recreate");
