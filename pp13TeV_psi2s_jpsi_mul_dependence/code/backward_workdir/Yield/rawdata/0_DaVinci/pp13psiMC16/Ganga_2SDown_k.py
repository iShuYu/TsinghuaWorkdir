...
data = BKQuery(dqflag = "OK" ,path  = "MC/2016/Beam6500GeV-2016-MagDown-Nu1.6-25ns-Pythia8/Sim09k/Trig0x61321609/Reco16/Turbo03a/Stripping28r2NoPrescalingFlagged/28142001/ALLSTREAMS.DST",type = "Path").getDataset()
