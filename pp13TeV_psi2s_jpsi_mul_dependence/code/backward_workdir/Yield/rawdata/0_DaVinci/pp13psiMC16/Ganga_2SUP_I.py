...
data = BKQuery(dqflag = "OK" ,path  = "MC/2016/Beam6500GeV-2016-MagUp-Nu1.6-25ns-Pythia8/Sim09i/Trig0x6139160F/Reco16/Turbo03/Stripping28r2NoPrescalingFlagged/28142001/ALLSTREAMS.DST",type = "Path").getDataset()
