...
// Mon Dec 12 13:17:16 2022 by ROOT version 6.24/06
// from TTree DecayTree/DecayTree
// found on file: Jpsi_splot_n1y1pt1.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Jpsi_splot_n1y1pt1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Jpsi_splot_n1y1pt1.root");
      }
