...
int main(int argc, char* argv[])
{
	...
	lhcbName->Draw();
	Titleb -> Draw("same");
	canp -> SaveAs("../4_Plot/promptRatioYB.pdf");
	canp -> SaveAs("../4_Plot/promptRatioYB.png");
	canp -> SaveAs("../4_Plot/promptRatioYB.eps");
	canp -> SaveAs("../4_Plot/promptRatioYB.C");

	canp -> Close();
	canb -> SaveAs("../4_Plot/frombRatioYB.pdf");
	canb -> SaveAs("../4_Plot/frombRatioYB.png");
        canb -> SaveAs("../4_Plot/frombRatioYB.eps");
        canb -> SaveAs("../4_Plot/frombRatioYB.C");
