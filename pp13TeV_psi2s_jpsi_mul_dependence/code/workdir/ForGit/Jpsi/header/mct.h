...
// Mon Mar 28 20:33:30 2022 by ROOT version 6.24/06
// from TTree mct/mct
// found on file: mctn5_total.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("mctn5_total.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("mctn5_total.root");
      }
