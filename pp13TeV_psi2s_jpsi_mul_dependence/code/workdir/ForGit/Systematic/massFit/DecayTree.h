...
// Tue Mar  1 16:06:34 2022 by ROOT version 6.24/06
// from TTree DecayTree/DecayTree
// found on file: ../../1_Rootfile/data/MagUp/2/output/Tuple.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../1_Rootfile/data/MagUp/2/output/Tuple.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../1_Rootfile/data/MagUp/2/output/Tuple.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../../1_Rootfile/data/MagUp/2/output/Tuple.root:/tuple1");
