...
// Tue Mar  1 16:11:39 2022 by ROOT version 6.24/06
// from TTree DecayTree/DecayTree
// found on file: ../../1_Rootfile/MC/MagUp/Jpsi/9/output/Tuple.root
//////////////////////////////////////////////////////////
...
#ifdef MCJpsi_cxx
MCJpsi::MCJpsi(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../1_Rootfile/MC/MagUp/Jpsi/9/output/Tuple.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../1_Rootfile/MC/MagUp/Jpsi/9/output/Tuple.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../../1_Rootfile/MC/MagUp/Jpsi/9/output/Tuple.root:/tuple1");
...
Int_t MCJpsi::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MCJpsi::LoadTree(Long64_t entry)
{
...
void MCJpsi::Show(Long64_t entry)
{
...
Int_t MCJpsi::Cut(Long64_t entry)
{
