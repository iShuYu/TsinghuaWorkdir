...
int main(int argc, char* argv[])
{
        ...
        RooRealVar sigma1("sigma1", "sigma1", 1.9,0.01,8.);
        RooRealVar sigma2("sigma2", "sigma2",0.6816,0.01,8. );
        RooRealVar beta("beta", "beta", 0.1, 0.0, 1.);
        RooRealVar tau("tau", "tau" ,1.45,0.02,5);
