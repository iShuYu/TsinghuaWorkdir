...
int main(int argc, char* argv[])
{
        ...
        RooRealVar bias("bias", "bias", -0.03, -1., 1.);
        RooRealVar sigma1("sigma1", "sigma1", 0.4236,0.01,8.);
        RooRealVar sigma2("sigma2", "sigma2",1.6816,0.01,8. );
        RooRealVar beta("beta", "beta", 0.5, 0.0, 1.);
        RooRealVar tau("tau", "tau" ,1.35,0.5,4);
        ...
        RooRealVar Nprompt("Nprompt", "Nprompt", 0.1*N, 0, N);
        RooRealVar Nfromb("Nfromb", "Nfromb", 0.03*N, 0, N);
