...
int main(int argc, char* argv[])
{
        ...
        RooRealVar psi_mass("psi_M", "psi_M", 3686. - 120, 3686. + 120);
        ...
        RooRealVar tau("tau", "tau" ,1.4,0.02,4);
        ...
        if (0)
	{
        ...
        RooFitResult *R = tzPDF.fitTo(data_set, Minos(true), Strategy(2), NumCPU(30), Save(), ConditionalObservables(tzError));
        int iter = 0;
