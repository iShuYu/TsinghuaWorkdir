...
// Thu Oct 17 08:16:39 2019 by ROOT version 6.06/02
...
#ifdef LumiTuple_cxx
LumiTuple::LumiTuple(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TDirectory * dir = (TDirectory*)f->Get("Tuple.root:/GetIntegratedLuminosity");
...
Int_t LumiTuple::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t LumiTuple::LoadTree(Long64_t entry)
{
...
void LumiTuple::Init(TTree *tree)
{
...
void LumiTuple::Show(Long64_t entry)
{
...
Int_t LumiTuple::Cut(Long64_t entry)
{
