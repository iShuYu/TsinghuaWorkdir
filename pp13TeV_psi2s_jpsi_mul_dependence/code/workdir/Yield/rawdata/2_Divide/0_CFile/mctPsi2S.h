...
// Tue Mar  1 15:58:03 2022 by ROOT version 6.24/06
// from TTree mct/mct
// found on file: ../../1_Rootfile/MC/MagUp/Psi2S/1/output/Tuple.root
//////////////////////////////////////////////////////////
...
#ifdef mctPsi2S_cxx
mctPsi2S::mctPsi2S(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../1_Rootfile/MC/MagUp/Psi2S/1/output/Tuple.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../1_Rootfile/MC/MagUp/Psi2S/1/output/Tuple.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../../1_Rootfile/MC/MagUp/Psi2S/1/output/Tuple.root:/mct");
...
Int_t mctPsi2S::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t mctPsi2S::LoadTree(Long64_t entry)
{
...
void mctPsi2S::Show(Long64_t entry)
{
...
Int_t mctPsi2S::Cut(Long64_t entry)
{
