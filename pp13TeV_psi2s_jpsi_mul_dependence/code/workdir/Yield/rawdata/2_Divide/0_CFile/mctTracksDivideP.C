...
int main(int argc, char *argv[])
{
	...
	F_DecayTree -> Add("../../1_Rootfile/MCtracks/Psi2S/Tuple.root");
	mct Tree(F_DecayTree);
	int Num_Entries  = F_DecayTree->GetEntries();

	//output 1 from b
	TFile *F_DecayTree_out_fromb = new TFile("../../1_Rootfile/MCtracks/Psi2S/Tupleb.root","recreate");
	...
	//output 1 prompt
	TFile *F_DecayTree_out_prompt = new TFile("../../1_Rootfile/MCtracks/Psi2S/Tuplep.root","recreate");
