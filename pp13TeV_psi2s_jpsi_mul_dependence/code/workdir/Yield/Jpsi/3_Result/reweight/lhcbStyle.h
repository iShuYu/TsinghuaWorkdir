...
///////////////////////////////////////////////////////////////////
  ...
  // label offsets
  lhcbStyle->SetLabelOffset(0.020,"X");
  lhcbStyle->SetLabelOffset(0.020,"Y");
  lhcbStyle->SetLabelOffset(0.030,"Z");
  ...
  //titles
  lhcbStyle->SetTitleOffset(1.3,"X");
  lhcbStyle->SetTitleOffset(1.3,"Y");
  lhcbStyle->SetTitleOffset(1.3,"Z");
