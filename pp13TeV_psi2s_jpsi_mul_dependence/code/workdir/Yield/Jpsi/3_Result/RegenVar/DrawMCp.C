void DrawMCp()
{
	TFile *out = TFile::Open("newVarMCp.root");
	...
	Pro->SetTitle("2016 pp 13TeV MC (prompt J/#psi)");
	...
	leg->AddEntry(Pro2, "Matched to Data");
        leg->AddEntry(Pro1, "Matched then Corrected");
