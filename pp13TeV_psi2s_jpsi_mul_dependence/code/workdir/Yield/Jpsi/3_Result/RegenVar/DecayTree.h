...
// Fri Apr 12 16:48:47 2024 by ROOT version 6.30/04
// from TTree DecayTree/DecayTree
// found on file: newVar.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("newVar.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("newVar.root");
      }
