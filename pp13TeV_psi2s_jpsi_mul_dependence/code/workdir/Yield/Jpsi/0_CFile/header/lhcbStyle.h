...
///////////////////////////////////////////////////////////////////
  ...
  lhcbStyle->SetPadBottomMargin(0.21);
  ...
  lhcbStyle->SetTitleSize(2*lhcbTSize, "t");
  ...
  // add LHCb label
  lhcbName = new TPaveText(0.59,0.8,0.79,0.9, "BRNDC");
...
//  lhcbName->AddText("LHCb Preliminary");
 // lhcbName->AddText("#sqrt{s} = 5 TeV");
  lhcbName->AddText("LHCb #sqrt{s} = 13 TeV");
