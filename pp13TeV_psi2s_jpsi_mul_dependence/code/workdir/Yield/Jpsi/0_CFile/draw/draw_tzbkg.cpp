...
int main(int argc, char* argv[])
{
	...
	tzPDF->plotOn(plot_frame,Name("tzPN"), ProjWData(tzError, *BinData), NumCPU(40, kTRUE), Components("tzPN"), FillColor(9), FillStyle(3005), VLines(), DrawOption("F"),  Normalization(1.0/N),LineWidth(0));
	...
	plot_frame->Draw();
	TLegend* leg = new TLegend(0.65, 0.65, 0.94, 0.98);
	leg->SetTextFont(132);
	leg->SetBorderSize(0);
	...
	leg->Draw("same");
	TLegend* leg1 = new TLegend(0.1, 0.5, 0.4, 0.6);
	leg1 -> SetHeader("Non-official");
	leg1->Draw("same");
