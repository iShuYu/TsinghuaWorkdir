...
// Sun Apr 14 13:33:31 2024 by ROOT version 6.30/04
// from TTree DecayTree/DecayTree
// found on file: ../../Jpsi/3_Result/RegenVar/newVar.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../Jpsi/3_Result/RegenVar/newVar.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../Jpsi/3_Result/RegenVar/newVar.root");
      }
...
void DecayTree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("PVNcor", &PVNcor, &b_PVNcor);
   fChain->SetBranchAddress("nFcor", &nFcor, &b_nFcor);
   fChain->SetBranchAddress("nBcor", &nBcor, &b_nBcor);
   Notify();
}
