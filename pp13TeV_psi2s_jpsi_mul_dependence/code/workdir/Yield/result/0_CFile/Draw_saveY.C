...
int main(int argc, char* argv[])
{
	...
	canp -> SaveAs("../4_Plot/promptRatioY.png");
	canp -> SaveAs("../4_Plot/promptRatioY.eps");
	canp -> SaveAs("../4_Plot/promptRatioY.C");

	canp -> Close();
	canb -> SaveAs("../4_Plot/frombRatioY.pdf");
	canb -> SaveAs("../4_Plot/frombRatioY.png");
        canb -> SaveAs("../4_Plot/frombRatioY.eps");
        canb -> SaveAs("../4_Plot/frombRatioY.C");
