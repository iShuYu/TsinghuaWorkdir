...
do
        ...
        ./XPosition ../3_Result/JpsiMultiplicityDistPT${i}.root "Sb" ../3_Result/Psi2SMultiplicityDistPT${i}.root "Sb" ../../rawdata/3_Bins/nbin 10000 "../4_Plot/JpsiFrombPT${i}" "../4_Plot/Psi2SFrombPT${i}" ../3_Result/frombBinPT${i}.txt ../3_Result/frombBinPTErr${i}.txt
done
