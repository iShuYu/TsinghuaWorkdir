...
int main()
{
	...
	//Hp->SetTitle("prompt-#psi(2S) #font[12]{p}_{T}-#font[12]{y} distribution");
	...
	leg->SetHeader("prompt-#psi(2S) #font[12]{p}_{T}-#font[12]{y} distribution");
	...
	//Hb->SetTitle("non-prompt #psi(2S) #font[12]{p}_{T}-#font[12]{y} distribution");
	...
	leg1->SetHeader("non-prompt #psi(2S) #font[12]{p}_{T}-#font[12]{y} distribution");
