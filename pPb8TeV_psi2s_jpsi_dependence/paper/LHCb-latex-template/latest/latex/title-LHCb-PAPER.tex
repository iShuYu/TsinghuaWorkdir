...
\begin{abstract}
  \noindent
	The ratio of prompt and non-prompt production of \psitwos and \jpsi charmonium states is studies as a function of multiplicity in $p$Pb collisions at a center-of-mass energy $\sqrt{s_{NN}}=8.16TeV$ at the LHC. The total luminosity is 13.6 nb$^{-1}$ for $p$Pb collisions and 20.8 nb$^{-1}$ for Pb$p$ collisions. Measurements are performed in dimuon channel at forward and backward rapidity with range $1.5<y^*<4.0$ ($-5.0<y^*<-2.5$)  for $p$Pb (Pb$p$) collisions.
        A multiplicity-dependent modification of the ratio has been observed for prompt charmonia in $p$Pb collisions. No evident modification of same significance for that of non-prompt component is observed. In Pb$p$ collisions, there is a overall reduction in the ratio compared to that in $p$Pb collisions, but no obvious decreasing trend on the ratio is observed for both prompt and non-prompt mesons. The ratio as a function of multiplicity is compared to co-mover model calculation.
