...
\begin{figure}[!tbp]
\begin{center}
\includegraphics[width=0.49\linewidth]{pdf/pPb/Workdir/TrackTable/pPb.pdf}
\includegraphics[width=0.49\linewidth]{pdf/pPb/Workdir/TrackTable/Pbp.pdf}
\end{center}
...
\end{center}
\caption{
	Fit Gaussian functions on the distributions of 1000-trial $R_{eff}$'s in different $N^{\rm PV}_{\rm tracks}$ classes.}
\label{ReffPlots}
\end{figure}
\input{Table/Eff/Eff_$N^{\rm PV}_{\rm tracks}$.tex}
