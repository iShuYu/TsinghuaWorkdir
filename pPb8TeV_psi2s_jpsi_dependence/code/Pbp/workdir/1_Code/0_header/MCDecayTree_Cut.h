...
// Fri Apr 21 18:02:42 2023 by ROOT version 6.24/08
// from TTree DecayTree/DecayTree
// found on file: Jpsi.root
//////////////////////////////////////////////////////////

#ifndef MCDecayTree_Cut_h
#define MCDecayTree_Cut_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   MCDecayTree_Cut(TTree *tree=0);
   virtual ~MCDecayTree_Cut();
...
#ifdef MCDecayTree_Cut_cxx
MCDecayTree_Cut::MCDecayTree_Cut(TTree *tree) : fChain(0) 
{
...
MCDecayTree_Cut::~MCDecayTree_Cut()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MCDecayTree_Cut::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MCDecayTree_Cut::LoadTree(Long64_t entry)
{
...
void MCDecayTree_Cut::Init(TTree *tree)
{
...
void MCDecayTree_Cut::Show(Long64_t entry)
{
...
Int_t MCDecayTree_Cut::Cut(Long64_t entry)
{
...
#endif // #ifdef MCDecayTree_Cut_cxx
