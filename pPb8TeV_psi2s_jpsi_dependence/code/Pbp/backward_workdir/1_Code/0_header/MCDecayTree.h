...
// Thu Apr 20 15:38:34 2023 by ROOT version 6.24/08
// from TTree DecayTree/DecayTree
// found on file: Jpsi_Full_MC_prompt.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Jpsi_Full_MC_prompt.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Jpsi_Full_MC_prompt.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("Jpsi_Full_MC_prompt.root:/tuple1");
