...
// Fri Apr 21 16:48:19 2023 by ROOT version 6.24/08
// from TTree DecayTree/DecayTree
// found on file: Jpsi.root
//////////////////////////////////////////////////////////
...
#ifdef sPlot_cxx
sPlot::sPlot(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Jpsi.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Jpsi.root");
      }
...
Int_t sPlot::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t sPlot::LoadTree(Long64_t entry)
{
...
void sPlot::Show(Long64_t entry)
{
...
Int_t sPlot::Cut(Long64_t entry)
{
