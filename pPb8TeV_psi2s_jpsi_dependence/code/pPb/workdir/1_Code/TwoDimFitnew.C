...
int main(int argc, char* argv[])
{
	...
	double fmass_meanP, fmass_sigmaP1, fmass_alphaP1,fmass_sigmaP2, fmass_alphaP2, fmass_ratioP, fmass_p0P;
	double trash;
	ifstream fmass(argv[4]);
	fmass >> trash;
	fmass >> trash;
        fmass >> fmass_mean >> fmass_sigma1 >> fmass_sigma2 >> fmass_alpha1 >> fmass_alpha2 >> fmass_ratio >> fmass_p0 >> fmass_meanP >> fmass_sigmaP1 >> fmass_sigmaP2 >> fmass_alphaP1 >> fmass_alphaP2 >> fmass_ratioP >> fmass_p0P;
	fmass.close();
        RooRealVar mass_mean("mass_mean", "mass mean", fmass_mean);
        RooRealVar mass_meanP("mass_meanP", "mass meanP", fmass_meanP);
	RooRealVar mass_sigmaP1("mass_sigmaP1","mass_sigma_P1",fmass_sigmaP1);
	RooRealVar mass_sigmaP2("mass_sigmaP2","mass_sigma_P2",fmass_sigmaP2);
	...
	RooRealVar mass_ratioP("mass_ratioP", "mass ratioP", fmass_ratioP);
	...
	RooRealVar alphaP1("alphaP1","alphaP1",fmass_alphaP1);
	RooRealVar alphaP2("alphaP2","alphaP2",fmass_alphaP2);
	RooCBShape mass_myCB1("mass_myCB1", "CBMass1", psi_mass, mass_mean, mass_sigma1, alpha1, n);
        ...
        RooCBShape mass_signalP1("mass_signalP1", "mass signalP1", psi_massP, mass_meanP, mass_sigmaP1, alphaP1, n);
	RooCBShape mass_signalP2("mass_signalP2", "mass signalP2", psi_massP, mass_meanP, mass_sigmaP2, alphaP2, n);
	RooAddPdf mass_signalP("mass_signalP", "mass signalP", RooArgList(mass_signalP1, mass_signalP2), RooArgList(mass_ratioP));
