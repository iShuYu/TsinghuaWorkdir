...
int main(int argc, char* argv[])
{
	...
	SJ_N -> GetYaxis() -> SetRangeUser(0,0.11);
	SJ_N -> GetYaxis() -> SetTitle("Normalized");
	SJ_N -> SetStats(0);
	SJ_N -> SetTitle("sWeight data");
	SJ_N -> GetXaxis() -> SetTitle("#font[12]{N}_{tracks}^{PV}");
	...
	DJ_N -> GetYaxis() -> SetRangeUser(0,0.08);
	DJ_N -> GetYaxis() -> SetTitle("Normalized");
	DJ_N -> SetStats(0);
	DJ_N -> SetTitle("MC");
	DJ_N -> GetXaxis() -> SetTitle("#font[12]{N}_{tracks}^{PV}");
	...
	SJ_hiPT -> GetYaxis() -> SetRangeUser(0,0.20);
	...
	SP_hiPT -> GetYaxis() -> SetRangeUser(0,0.20);
	...
	SJ_loPT -> GetYaxis() -> SetRangeUser(0,0.20);
	...
	SP_loPT -> GetYaxis() -> SetRangeUser(0,0.20);
	...
	SJ_hiY -> GetYaxis() -> SetRangeUser(0,0.45);
	...
	SP_hiY -> GetYaxis() -> SetRangeUser(0,0.45);
	...
	SJ_loY -> GetYaxis() -> SetRangeUser(0,0.45);
	...
	SP_loY -> GetYaxis() -> SetRangeUser(0,0.45);
	...
	SJ_PT -> GetYaxis() -> SetRangeUser(0,0.20);
	...
	SJ_Y -> GetYaxis() -> SetRangeUser(0,0.45);
