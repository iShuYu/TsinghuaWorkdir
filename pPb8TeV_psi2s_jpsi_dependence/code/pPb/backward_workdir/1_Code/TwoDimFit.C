...
int main(int argc, char* argv[])
{
	...
	//result from background 
        ...
        RooRealVar sigma1("sigma1", "sigma1", 0.7, 0.1,3.);
        //RooRealVar sigma2("sigma2", "sigma2", 0.7, 0.1, 3. );
        RooFormulaVar sigma2("sigma2","sigma2","2*sigma1", RooArgList(sigma1));
	RooRealVar beta("beta", "beta", 0.5, -0.1, 1.2);
        RooRealVar tau("tau", "tau" ,1.5,0.5,2.5);
        ...
        RooRealVar Nprompt("Nprompt", "Nprompt", 0.4*N, 0, N);
