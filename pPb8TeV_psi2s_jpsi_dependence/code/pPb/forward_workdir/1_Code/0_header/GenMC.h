...
// Fri Apr 21 12:15:46 2023 by ROOT version 6.24/08
...
#ifdef GenMC_cxx
GenMC::GenMC(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TDirectory * dir = (TDirectory*)f->Get("Jpsi.root:/MCDecayTreeTuple");
...
Int_t GenMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t GenMC::LoadTree(Long64_t entry)
{
...
void GenMC::Show(Long64_t entry)
{
...
Int_t GenMC::Cut(Long64_t entry)
{
