...
int main(int argc, char* argv[])
{
	...
	SJ_N -> GetXaxis() -> SetTitle("#font[12]{N}_{fwd}^{PV}");
	...
	DJ_N -> SetStats(0);
	DJ_N -> SetTitle("MC");
	DJ_N -> GetXaxis() -> SetTitle("#font[12]{N}_{fwd}^{PV}");
	...
	SJ_hiY -> GetYaxis() -> SetRangeUser(0,0.4);
	...
	SP_hiY -> GetYaxis() -> SetRangeUser(0,0.4);
	...
	SJ_loY -> GetYaxis() -> SetRangeUser(0,0.4);
	...
	SP_loY -> GetYaxis() -> SetRangeUser(0,0.4);
