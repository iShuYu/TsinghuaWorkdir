...
{
	//input
	int hi_lo = 56; //mean of PVNTRACKS, divide hi lo sample
	TH1::SetDefaultSumw2();
	...
	double PT, Y, N, w;
	TH1D *SJ_N = new TH1D("SJ_N","SJ_N",30,0,150);
	TH1D *SP_N = new TH1D("SP_N","SP_N",30,0,150);
	TH1D *DJ_N = new TH1D("DJ_N","DJ_N",30,0,150);
	TH1D *DP_N = new TH1D("DP_N","DP_N",30,0,150);
	...
	//Save
	TH1D *wJ_N = new TH1D("wJ_N","wJ_N",30,0,150);
	TH1D *wP_N = new TH1D("wP_N","wP_N",30,0,150);
